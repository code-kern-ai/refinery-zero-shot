# refinery-zero-shot [![Build Status](https://drone.dev.kern.ai/api/badges/code-kern-ai/refinery-zero-shot/status.svg?ref=refs/heads/dev)](https://drone.dev.kern.ai/code-kern-ai/refinery-zero-shot)
